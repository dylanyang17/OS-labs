...
pub fn mmap(start: usize, len: usize, prot: usize) -> i32 {
    current_task().unwrap().acquire_inner_lock().memory_set.mmap(start, len, prot)
}

pub fn munmap(start: usize, len: usize) -> i32 {
    current_task().unwrap().acquire_inner_lock().memory_set.munmap(start, len)
}
